// Windows Phone 8.1 Metro Icons - Segoe MDL2 Style
export const ICONS = {
    ...
    rotation: <path d="M16.48 2.52c3.27 1.55 5.61 4.72 5.97 8.48h1.5C23.44 4.84 18.29 0 12 0l-.66.03 3.81 3.81 1.33-1.32zm-6.25-.77c-.59-.59-1.54-.59-2.12 0L1.75 8.11c-.59.59-.59 1.54 0 2.12l12.02 12.02c.59.59 1.54.59 2.12 0l6.36-6.36c.59-.59.59-1.54 0-2.12L10.23 1.75zm4.6 19.44L2.81 9.17l6.36-6.36 12.02 12.02-6.36 6.36zm-7.31.29l-3.81-3.81-.66.03c0 6.29 4.84 11.44 11 11.97v-1.5c-3.76-.36-6.93-2.7-8.48-5.97l1.95-.72z" />,
    chevronUp: <path d="M7.41 15.41L12 10.83l4.59 4.58L18 14l-6-6-6 6z" />,
    ...
    signal: <path d="M2 22h20V2L2 22zm18-2h-3V9.83l3-3V20z" />,
};
