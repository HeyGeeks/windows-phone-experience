...
export const ICONS = {
    ...
    alarm: <path d="M22 5.72l-4.6-3.86-1.29 1.53 4.6 3.86L22 5.72zM7.88 3.39L6.6 1.86 2 5.71l1.29 1.53 4.59-3.85zM12 4c-4.97 0-9 4.03-9 9s4.03 9 9 9 9-4.03 9-9-4.03-9-9-9zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7zm.5-11H11v5l4.25 2.55.75-1.23-3.5-2.07V9z" />,
    ...
    notes: <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zM6 20V4h7v5h5v11H6z" />,
    ...
    windows: <path d="M3 12V6.75l6-1.32v6.48L3 12zm17-9v8.75l-10 .15V5.21L20 3zM3 13l6 .09v6.81l-6-1.15V13zm17 .25V22l-10-1.91V13.1l10 .15z" />,
    ...
    wifi: <path d="M1 9l2 2c4.97-4.97 13.03-4.97 18 0l2-2C16.93 2.93 7.08 2.93 1 9zm8 8l3 3 3-3a4.237 4.237 0 00-6 0zm-4-4l2 2a7.074 7.074 0 0110 0l2-2C15.14 9.14 8.87 9.14 5 13z" />,
    ...
    office: <path d="M14 2H6c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8l-6-6zm-1 9h-2v1h3v2h-3v1h3v2h-3v2H9v-2H7v-2h2v-1H7v-2h2v-1H7V9h2V7h2v2h2v2z" />,
    xbox: <path d="M6.43 3.72C6.43 3.72 8.09 2 12 2s5.57 1.72 5.57 1.72c.67.42.97 1.27.73 2.02-.73 2.25-2.06 5.12-3.3 7.26-1.24 2.14-2.5 3.5-3 3.5s-1.76-1.36-3-3.5c-1.24-2.14-2.57-5.01-3.3-7.26-.24-.75.06-1.6.73-2.02zM4.5 6.5c-.83 0-1.5.67-1.5 1.5 0 4.97 3.13 9.2 7.5 10.82V22h3v-3.18c4.37-1.62 7.5-5.85 7.5-10.82 0-.83-.67-1.5-1.5-1.5-.5 0-.94.25-1.21.62C17.5 9.5 15 13 12 13s-5.5-3.5-6.29-5.88c-.27-.37-.71-.62-1.21-.62z" />,
};
